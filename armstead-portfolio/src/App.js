...
READY? GET SET? UNWIND!" img={entertainment} />
      ...
      <Project title="Budget Tracker" text="This app is designed to allow for offline access and functionality. It lets a user add or subtract and keep track of their transactions both on and offline." img={budgetTracker} />
